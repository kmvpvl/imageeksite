...
<meta name="application-name" content="SH">
...
Для тех, кто понял, что информационные технологии на русском языке не существуют</p><p>
...
<p>Откажитесь если:
<li> ребенку сдавать экзамены, потому что нашим занятиям ребенок совершенно добровольно будет посвящать всё свое свободное время</li>
<li>Компьютер интересует ребенка только как игровая приставка</li>
<li>Если у ребенка есть ограничения по зрению, невропатологии, психопатологии и еще 100500 других занятий</li>
</p><p>Вы точно пришли по адресу, если:
<li>у ребенка потребность и желание возиться с компьютером для создания нового</li>
<li>Вы хотите, чтобы в будущем ребенок имел возможность без дополнительного обучения работать заграницей</li>
...
<iframe src="https://calendar.google.com/calendar/embed?height=600&amp;wkst=2&amp;bgcolor=%23ffffff&amp;ctz=Europe%2FMoscow&amp;src=M2Z1OGJlc3IzZm00OTNyb2d0aWwzcnZ1ZGNAZ3JvdXAuY2FsZW5kYXIuZ29vZ2xlLmNvbQ&amp;color=%23F09300&amp;mode=AGENDA&amp;showTitle=0&amp;showPrint=0&amp;showCalendars=0" style="border-width:0" width="100%" height="600" frameborder="0" scrolling="no"></iframe>
</div>
<?php
include "footer.php";
?>
